...
describe('City Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '23758c6a-e922-4595-b3e2-be143d026188' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'caae2f98-09cb-467a-ae94-505a232ee840' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.cities()[0]).toEqual(expect.objectContaining({ id: '23758c6a-e922-4595-b3e2-be143d026188' }));
  });
