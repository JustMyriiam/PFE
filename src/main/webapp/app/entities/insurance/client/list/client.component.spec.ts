...
describe('Client Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'c8e41822-3cf0-4cba-a9bb-eac01142b7ff' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '687bb8c0-68bf-47c8-b217-55897bbb16b1' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.clients()[0]).toEqual(expect.objectContaining({ id: 'c8e41822-3cf0-4cba-a9bb-eac01142b7ff' }));
  });
