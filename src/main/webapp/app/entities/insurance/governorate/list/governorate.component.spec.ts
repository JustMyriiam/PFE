...
describe('Governorate Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '06b5bd02-0f85-4d95-9111-578d64b53b5c' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '115a502d-2c89-49eb-b046-b41ce5c05608' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.governorates()[0]).toEqual(expect.objectContaining({ id: '06b5bd02-0f85-4d95-9111-578d64b53b5c' }));
  });
