...
describe('Quote Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a Quote', () => {
    ...
    describe('compareQuote', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '4bc6776a-0dac-4853-b88a-48033f316c97' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: '4bc6776a-0dac-4853-b88a-48033f316c97' };
        const entity2 = { id: '7e96257b-a9d4-4759-88b1-865c11475b23' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '4bc6776a-0dac-4853-b88a-48033f316c97' };
        const entity2 = { id: '4bc6776a-0dac-4853-b88a-48033f316c97' };
