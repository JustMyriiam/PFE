...
import { RestVehicle, VehicleService } from './vehicle.service';

const requireRestSample: RestVehicle = {
  ...sampleWithRequiredData,
  firstRegistrationDate: sampleWithRequiredData.firstRegistrationDate?.format(DATE_FORMAT),
...
describe('Vehicle Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a Vehicle', () => {
    ...
    describe('compareVehicle', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '9bb49fc1-a9df-4adb-bc15-4a7db764498f' };
        const entity2 = null;
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '9bb49fc1-a9df-4adb-bc15-4a7db764498f' };
        const entity2 = { id: '9bb49fc1-a9df-4adb-bc15-4a7db764498f' };
