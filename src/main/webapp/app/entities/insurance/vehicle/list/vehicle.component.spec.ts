...
describe('Vehicle Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '9bb49fc1-a9df-4adb-bc15-4a7db764498f' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '941cfd1a-85dd-4b32-ba45-08e99fd1406f' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.vehicles()[0]).toEqual(expect.objectContaining({ id: '9bb49fc1-a9df-4adb-bc15-4a7db764498f' }));
  });
