...
import { sampleWithRequiredData } from '../client-address.test-samples';
...
describe('ClientAddress Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'ba359270-b697-420f-9c86-ece18688b5ef' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0a995b15-88f9-49d9-a2a6-95d4ec3e5923' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.clientAddresses()[0]).toEqual(expect.objectContaining({ id: 'ba359270-b697-420f-9c86-ece18688b5ef' }));
  });
