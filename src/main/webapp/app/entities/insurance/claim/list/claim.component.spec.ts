...
import { sampleWithRequiredData } from '../claim.test-samples';
...
describe('Claim Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '94ec77c2-f5a1-41a3-b8f8-7bf9e231e536' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '8bb3b970-e511-4c38-8959-e76645f63e0c' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.claims()[0]).toEqual(expect.objectContaining({ id: '94ec77c2-f5a1-41a3-b8f8-7bf9e231e536' }));
  });

  describe('trackId', () => {
    it('should forward to claimService', () => {
      const entity = { id: '94ec77c2-f5a1-41a3-b8f8-7bf9e231e536' };
