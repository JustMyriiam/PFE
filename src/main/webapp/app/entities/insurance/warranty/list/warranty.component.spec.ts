...
import { sampleWithRequiredData } from '../warranty.test-samples';
...
describe('Warranty Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '02209a44-8170-48fc-bfe9-76651f25b708' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0e791b1b-70a5-4e8a-8534-6a5596acad14' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.warranties()[0]).toEqual(expect.objectContaining({ id: '02209a44-8170-48fc-bfe9-76651f25b708' }));
  });

  describe('trackId', () => {
    it('should forward to warrantyService', () => {
      const entity = { id: '02209a44-8170-48fc-bfe9-76651f25b708' };
      jest.spyOn(service, 'getWarrantyIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWarrantyIdentifier).toHaveBeenCalledWith(entity);
