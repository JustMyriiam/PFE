...
describe('Agency Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '4b7ed6c2-7221-414a-93bf-e1ec02bf3053' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'c64bfa10-4e04-4bbe-afe6-7ad1cca1790d' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.agencies()[0]).toEqual(expect.objectContaining({ id: '4b7ed6c2-7221-414a-93bf-e1ec02bf3053' }));
  });
