...
export class ContractComponent implements OnInit {
  private static readonly NOT_SORTABLE_FIELDS_AFTER_SEARCH = ['id', 'contractNumber', 'duration', 'contractType', 'paymentPlan'];
  ...
  trackId = (item: IContract): string => this.contractService.getContractIdentifier(item);
