...
describe('Contract Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'c75fa77d-c676-4967-8932-ebc2af9e9bf2' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '1c1580c0-eda0-4eb0-b560-f2603bd5cf93' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.contracts()[0]).toEqual(expect.objectContaining({ id: 'c75fa77d-c676-4967-8932-ebc2af9e9bf2' }));
  });
